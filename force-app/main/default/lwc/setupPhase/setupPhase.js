...
import getAllUserLicesnse from '@salesforce/apex/SoftwateEngOptimizerUtilityController.getAllUserLicesnse';
import { ShowToastEvent } from 'lightning/platformShowToastEvent';
import getAllEngagement from '@salesforce/apex/SoftwateEngOptimizerUtilityController.getAllEngagement';
import getAllPortfolios from '@salesforce/apex/SoftwateEngOptimizerUtilityController.getAllPortfolios';
import getAllProductDetails from '@salesforce/apex/SoftwateEngOptimizerUtilityController.getAllProductDetails';
import getAllEpicDetails from '@salesforce/apex/SoftwateEngOptimizerUtilityController.getAllEpicDetails';
import { NavigationMixin } from 'lightning/navigation';
import getUserName from '@salesforce/apex/SoftwateEngOptimizerUtilityController.getCurrentUserLicenseData';
import BA_PIC from '@salesforce/resourceUrl/BAPic';
import { avatarOptions, DEFAULT_ENGAGEMENT, DEFAULT_PORTFOLIO, DEFAULT_PRODUCT, DEFAULT_EPIC, DEFAULT_LICENSE } from './setupConstant';

export default class SetupPhase extends NavigationMixin(LightningElement) {
    @track userLicenses = [];
